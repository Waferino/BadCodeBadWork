...
type EventInfo () =
    ...
    member val DateOfThe = defaultof<string> with get, set
    member val whosEvent = defaultof<string> with get, set
    member val Name = defaultof<string> with get, set
    ...
    interface ICafedraEntities with
        member this.GetNamesOfProperties () =
            [| "УИД События"; "Ожидаемая дата проведения"; "Название события"; "Примачание к событию"; "Дата создания/изменения" |]
type Event () =
...
type AnceteInfo () =
    ...
    member val examenPower = defaultof<string> with get, set //
    member val kontract_startday = defaultof<string> with get, set
    member val who_pays_kontract = defaultof<string> with get, set
